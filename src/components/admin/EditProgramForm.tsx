...
//     title: initialData?.title || 'Bank Sampah Desa',
//     slug: initialData?.slug || 'bank-sampah-desa',
//     description: initialData?.description || 'Community recycling and waste management initiative for local residents.',
//     overview: initialData?.overview || 'Environmental education and waste sorting activities for village communities.',
//     status: initialData?.status || 'Upcoming',
//     startDate: initialData?.startDate || '2026-05-10',
//     endDate: initialData?.endDate || '2026-05-10',
