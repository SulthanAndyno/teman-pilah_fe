...
//           <h2 className="text-4xl lg:text-5xl font-bold">Tentang Teman Pilah</h2>
...
//         >
//           {[
//             { icon: Zap, title: 'Visi', desc: 'Menjadi pelopor gerakan masyarakat sadar lingkungan untuk Indonesia yang bersih, hijau, dan lestari.' },
//             { icon: Info, title: 'Misi', desc: 'Mengedukasi masyarakat, memfasilitasi pemilahan sampah, dan berkolaborasi dengan berbagai pihak.' },
//             { icon: Heart, title: 'Nilai', desc: 'Kepedulian, gotong royong, keberlanjutan, dan inovasi dalam setiap langkah pelestarian lingkungan.' }
//           ].map((item, idx) => (
//             <motion.div key={idx} variants={fadeInUp}>
//               <Card className="h-full group hover:border-primary transition-colors">
//                 <div className="w-16 h-16 bg-bg rounded-2xl flex items-center justify-center text-primary mb-6 mx-auto group-hover:bg-primary group-hover:text-white transition-all">
//                   <item.icon size={32} />
//                 </div>
//                 <h3 className="text-2xl font-bold mb-4">{item.title}</h3>
//                 <p className="text-neutral leading-loose">{item.desc}</p>
//               </Card>
//             </motion.div>
//           ))}
//         </motion.div>
...
export function About() {
  ...
  return (
    <section id="tentang" className="py-24 bg-bg">
      <div className="max-w-7xl mx-auto px-6 text-center space-y-16">
        <motion.div {...fadeInUp} className="max-w-3xl mx-auto space-y-6">
