...
export const news: News[] = [
  {
    id: '1',
    title: 'Aksi Bersih Pantai Bersama Komunitas',
    category: 'Kampanye',
  ...
  {
    id: '2',
    title: 'Workshop Daur Ulang Plastik di Sekolah',
    category: 'Edukasi',
  ...
  {
    id: '3',
    title: 'Tips Mengompos di Apartemen yang Sempit',
    category: 'Tips & Trick',
  ...
  {
    id: '4',
    title: 'Peluncuran Katalog Produk Upcycled Terbaru',
    category: 'Produk',
  ...
  {
    id: '5',
    title: 'Mari Mengenal Simbol Daur Ulang Plastik',
    category: 'Edukasi',
